...
if (!class_exists('Puc_v4p2_Metadata', false)):
    ...
    abstract class Puc_v4p2_Metadata {
         ...
         * @return self
         */
        public static function fromJson(/** @noinspection PhpUnusedParameterInspection */
            $json) {
         ...
         */
        protected function validateMetadata(/** @noinspection PhpUnusedParameterInspection */
            $apiResponse) {
            return true;
        }
         ...
         */
        public static function fromObject(/** @noinspection PhpUnusedParameterInspection */
            $object) {
            throw new LogicException('The ' . __METHOD__ . ' method must be implemented by subclasses');
        }
